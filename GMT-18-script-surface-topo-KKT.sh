...
gmt grdgradient Surface_KKT.nc -GSurface_KKT.int -A0/45 -Ne1 -fg
# Step-10. Make raster image
#gmt grdimage Surface_KKT.nc -Csurface.cpt -R144/162/40/51 -JM6i -P -I+a15+ne0.75 -Xc -K > $ps
gmt grdimage Surface_KKT.nc -Csurface.cpt -R144/162/40/51 -JM6i -P -ISurface_KKT.int -Xc -K > $ps
# Step-11. Add grid
gmt psbasemap -R -J \
...
gmt psconvert SurfaceTKKT.ps -A0.2c -E720 -P -Tj -Z
