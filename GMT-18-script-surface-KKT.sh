...
# GMT modules: gmtset, gmtdefaults, makecpt, gmtinfo, surface, grdimage, psscale, grdcontour, psbasemap, gmtlogo, psconvert
...
# Step-7. Generate grid from xyz table format
gmt surface topo_KKT.xyz -R144/162/40/51 -T0.25 -I30s -GSurface_KKT.nc -Vv
# Step-8. Make raster image
...
1.7 13.2 Input raw table data: global 1-min grid resolution in ASCII XYZ-format.
